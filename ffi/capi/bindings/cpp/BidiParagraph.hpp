...
inline const capi::ICU4XBidiParagraph* BidiParagraph::AsFFI() const {
  return reinterpret_cast<const capi::ICU4XBidiParagraph*>(this);
}

inline capi::ICU4XBidiParagraph* BidiParagraph::AsFFI() {
  return reinterpret_cast<capi::ICU4XBidiParagraph*>(this);
}

inline const BidiParagraph* BidiParagraph::FromFFI(const capi::ICU4XBidiParagraph* ptr) {
  return reinterpret_cast<const BidiParagraph*>(ptr);
}

inline BidiParagraph* BidiParagraph::FromFFI(capi::ICU4XBidiParagraph* ptr) {
