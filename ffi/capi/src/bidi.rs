...
pub mod ffi {
    ...
    impl Bidi {
        ...
        pub fn create(provider: &ICU4XDataProvider) -> Result<Box<Bidi>, ICU4XDataError> {
        ...
        pub fn for_text<'text>(
            ...
            Some(Box::new(BidiInfo(unicode_bidi::BidiInfo::new_with_data_source(
                &adapter,
                text,
        ...
        pub fn reorder_visual(&self, levels: &[u8]) -> Box<ReorderedIndexMap> {
            ...
            Box::new(ReorderedIndexMap(unicode_bidi::BidiInfo::reorder_visual(levels)))
        }
        ...
        pub fn level_is_rtl(level: u8) -> bool {
            unicode_bidi::Level::new(level).unwrap_or_else(|_| unicode_bidi::Level::ltr()).is_rtl()
        }
        ...
        pub fn level_is_ltr(level: u8) -> bool {
            unicode_bidi::Level::new(level).unwrap_or_else(|_| unicode_bidi::Level::ltr()).is_ltr()
        }
