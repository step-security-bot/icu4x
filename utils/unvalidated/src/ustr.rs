...
#[cfg(feature = "zerovec")]
impl<'a> zerovec::maps::ZeroMapKV<'a> for UnvalidatedStr {
    type Container = zerovec::VarZeroVec<'a, UnvalidatedStr>;
    type Slice = zerovec::VarZeroSlice<UnvalidatedStr>;
...
#[cfg(feature = "zerovec")]
unsafe impl zerovec::ule::VarULE for UnvalidatedStr {
    #[inline]
